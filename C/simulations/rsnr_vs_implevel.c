/** @file rsnr_vs_implevel.c
 *  @brief 	C routine that generates the data for building the Figure 2(c).

Figure 2(c) shows reconstruction SNR (R-SNR) obtained for the reconstructed signal using an increasing set of impulsiveness levels, where the R-SNR is just the negative of NMSE in dB.
